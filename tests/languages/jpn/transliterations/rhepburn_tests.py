...
################################################################################
"""
    ❏DChars❏ : dchars/tests/languages/jpn/transliterations/rhepburn_tests.py
"""
...
DSTRING_JPN = new_dstring(language="jpn",
                          transliteration_method="rhepburn",
...
class TESTSDStringJPN(unittest.TestCase):
    """
        ...
        We test dchars.languages.jpn.transliterations.rhepburn.py
    """
    ...
    def test_from_srcstr_2_srcstr(self):
        ...
        for jpn, jpn_rhepburn in LIST_OF_RECIPROCAL_EXAMPLES:

            string = DSTRING_JPN().init_from_transliteration(jpn_rhepburn)
            self.assertEqual( jpn, str(string) )
            jpn_rhepburn2 = string.get_transliteration()
            self.assertEqual( jpn_rhepburn, jpn_rhepburn2 )
