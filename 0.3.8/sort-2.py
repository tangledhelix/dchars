...
"""
    ...
    * create two lists (see the documentation below) of the syllables stored
      in src1 (e.g. a simple list of unicode Tibetan words) and src2 (e.g. a
...
def modifications_tibspellchecker( srclist ):
    ...
    for src in srclist:
        ...
        if src.istructs[0].suffix1 is None and \
           ...
           src.istructs[0].postsuffix_u:
            ...
            if ARGS.bod_addewts == "yes":
                transl = " # " + src.get_transliteration()
            else:
                transl = ""
        ...
        # src + /A if no suffix :
           ...
           src.istructs[0].suffix2 is None:
...
if ARGS.source is not None:
    ...
    if ARGS.modifications is None:
        ...
        #for data in DATA:
        #    print(">>"+str(data)+"<<"+data.get_transliteration()+"<<")
