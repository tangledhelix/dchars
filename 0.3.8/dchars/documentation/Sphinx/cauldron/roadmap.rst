...
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
schéma entièrement à revoir
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
dstring.__str__() renvoie [ dchar.get_sourcestr_representation() ]

dstringbod[2] = DCharacterBOD( base_char="TIBETAN LETTER MA" )
istruct[0] = InternalStructure( prefix = "TIBETAN LETTER MA" )
...
(2a)  DStringBOD.init_from_str() > ewts.py::get_intstruct_from_str
(2b)  "".join([str(char) for char in self]) => DCharacterBOD.get_sourcestr_representation()
(3a)  [ istruct.get_the_corresponding_dchars() ]
(3b)  ewts_international_structure.py::get_intstructures_from_dstring()
